...
public class Biblioteca {
	...
	private CodiciIdentificativi codici_dentificativi;
	...
	public CodiciIdentificativi getCodici_dentificativi() {
		return codici_dentificativi;
	}

	public void setCodici_dentificativi(CodiciIdentificativi codici_dentificativi) {
		this.codici_dentificativi = codici_dentificativi;
	}
