        ...
        link: function (scope, element, attr) {
          ...
          scope.$watchGroup([
            ...
            if (options.acceptButton) {
              acceptButton = '<a href="" class="cl-accept" ng-click="accept()">{{"cookies_accept" | translate}}</a>';
            }
            ...
            template =
              '<div class="cl-banner ' + options.position + '"><p>' + options.message + '' + acceptButton + declineButton + policyButton + '</p></div>';
